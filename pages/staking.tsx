...
const Staking: NextPage = () => {
  ...
  const [user, setUser] = useState('validator');
    ...
    <div className="col-lg-6 pr-25 md-pr-15">
      <div className="project-item" style={{borderRadius: "4px"}}>
        <div className="project-info border-bottom-2">
          <h4 className="mb-15">
            Become a Validator {" "} 
            <span style={{fontSize:"0.75rem", fontWeight:"300", color:"#0DB2FF", cursor:"pointer"}} onClick={() => setUser('nominator')}>
              or participate as nominator
            </span>
          </h4>
          <h3 className="mb-15">
